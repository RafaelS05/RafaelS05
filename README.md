...
Cartago, Costa Rica · Software Engineering student (expected 2027)

---

I build secure, scalable REST APIs and microservices with a focus on authentication — JWT, OAuth2, MFA, BCrypt, and RBAC. Currently migrating my main project to a decoupled REST API (Screaming Architecture) with a React/Next.js frontend.
